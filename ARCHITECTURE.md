...
Credential Source Priority:
  ...
  2. DPAPI-encrypted file (%AppData%\GdouNetGuard\credentials.json)
...
Auto-save:
  ...
  persisted to the DPAPI store. Future runs can use stored credentials
  without environment variables.
```

## Startup & Background Models (Windows)
